                        ...
                        <div class="editor-side">
                          ...
                          <div class="form-group">
                            ...
                            <div style="display:flex;gap:12px;align-items:flex-start">
                              <div style="width:256px;height:256px;border:2px dashed #c4b89e;border-radius:12px;background:#f0e8d8;display:flex;align-items:center;justify-content:center;flex-shrink:0;overflow:hidden">
                                <img v-if="coverPreview" :src="coverPreview" style="width:256px;height:256px;object-fit:cover">
